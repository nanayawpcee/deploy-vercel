...
// ─── Card component ───────────────────────────────────────────────────────────
function DepartmentCard({ dept }: { dept: (typeof DEPARTMENT_GRID_DATA)[number] }) {
  return (
    <div
      style={{
        background: "#fff",
        ...
        <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
          {dept.services.map((svcName) => {
            ...
            const matchedService = SERVICES.find(
              (s) => s.title.toLowerCase() === svcName.toLowerCase() || 
                     ...
                     (svcName.includes("X-Ray") && s.slug === "imaging")||
                      ...
                      (svcName.includes("Dental ") && s.slug === "dental")||
...
export default function ServicesPage() {
  return (
    <>
      ...
      <section style={{ padding: "5rem 1.5rem 6rem", background: "var(--off-white, #F7FAF8)" }}>
        <div className="container" style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <AnimateIn>
            <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
              ...
              >
                Every service at St. Elizabeth Catholic Hospital falls within one of four core departments, each staffed by dedicated specialists.
              </p>
            </div>
          </AnimateIn>
          ...
          <AnimateIn delay={200}>
            ...
            >
              ...
              <Link
                href="/contact"
                style={{ color: "var(--primary, #0A4F3C)", fontWeight: 600, textDecoration: "underline" }}
              >
                Contact our team
              </Link>
              .
