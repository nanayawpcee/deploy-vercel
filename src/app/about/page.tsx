...
const VALUES = [
  { icon: "./icons/faith.png",  title: "Faith",      desc: "Rooted in Catholic values, we honour the dignity and sanctity of every human life." },
  { icon: "./icons/compassion.png", title: "Compassion", desc: "We treat every patient with empathy, kindness, and genuine care — regardless of background." },
  { icon: "./icons/excellence.png", title: "Excellence", desc: "We hold ourselves to the highest clinical and ethical standards in all we do." },
  { icon: "./icons/community.png", title: "Community",  desc: "We are deeply committed to the health and wellbeing of the communities we serve." },
];
  ...
  return (
    <>
      ...
      <section className="timeline-section">
        <div className="container">
          <AnimateIn>
            <div className="section-tag" style={{ justifyContent: "center" }}><span>Our Journey</span></div>
            <h2 className="section-heading" style={{ marginBottom: "5rem", textAlign: "center" }}>A History of Healing</h2>
          </AnimateIn>
          ...
          <div className="timeline-container">
            ...
            {MILESTONES.map((m, i) => {
              const isEven = i % 2 === 0;
              return (
                <AnimateIn key={m.year || i} delay={i * 100} direction={isEven ? "left" : "right"}>
                    ...
                    {isEven ? (
                      <div className="timeline-content-left">
                        ...
                        <div className="timeline-image-wrapper">
                          <Image src={m.image} alt={m.title} fill style={{ objectFit: "fill" }} />
                        </div>
                      </div>
                    ) : <div />}
                  ...
                  <div className="team-card-display">
                    ...
                    <div className="team-card-overlay">
                      <div className="team-social-row">
                        {member.facebook && (
                          <a href={member.facebook} className="team-social-icon" aria-label="Facebook">
                            <span className="emoji-icon">📘</span>
                          </a>
                        )}
                        {member.instagram && (
                          <a href={member.instagram} className="team-social-icon" aria-label="Instagram">
                            <span className="emoji-icon">📸</span>
                          </a>
                        )}
                        {member.linkedin && (
