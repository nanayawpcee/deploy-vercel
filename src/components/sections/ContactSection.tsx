...
const CONTACT_INFO = [
  { icon: "📍", label: "Address",  value: SITE.address,  href: "https://www.google.com/maps/place/St.+Elizabeth+Catholic+Hospital/@6.9325332,-2.3606433,17z" },
...
export function ContactSection() {
  ...
  return (
    <section id="contact" style={{ padding: "6rem 0", background: "var(--primary-dark)" }}>
      <div className="container">
        {/* FIX: 2-col grid stacks on mobile */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4.5rem" }}>
            ...
            <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: "var(--radius-lg)", padding: "2rem", border: "1px solid rgba(255,255,255,0.1)" }}>
              {submitted ? (
                ...
                <>
                  ...
                  {/* FIX: name grid stacks to 1-col on mobile via media query */}
